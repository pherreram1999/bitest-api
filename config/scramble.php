...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'REST API académico (bitets). Gestión de Carreras, Planes de Estudio, Unidades de Aprendizaje, Edificios, Salones, Áreas, Profesores y Exámenes. Autenticación: Sanctum personal access token (Bearer). Soft-deletes en todos los modelos.',
    ],
